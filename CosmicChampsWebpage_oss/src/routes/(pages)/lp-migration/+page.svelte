<script>
	...
	async function validate() {
		spinner = true;
		let data;
		const response = await fetch('/api/migration/lp', {
			method: 'POST',
...
<div class="content">
	<h1 class="title">
		COSG v2 <br /><span class="font-sm title--size-4">LP reimbursement</span>
	</h1>

	<div class="mb-3">Enter wallet address or NFDomain and see if you qualify for COSG v2 LP reimbursement</div>
	...
	<div class="mt-6 flex w-full justify-center">
		<a href="/cosg-migration" class="button button--primary"><span class="button__inner">Check my COSG compensation</span></a>
	</div>
</div>
