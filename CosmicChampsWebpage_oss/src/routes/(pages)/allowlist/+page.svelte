...
<div class="content">
	<h1 class="title">Season 2 Allow List <br /><span class="font-sm title--size-4">(Private shuffle)</span></h1>
	<div class="mb-3 -mt-4">Enter your wallet address or NFD and check if you are eligible for the private round:</div>
