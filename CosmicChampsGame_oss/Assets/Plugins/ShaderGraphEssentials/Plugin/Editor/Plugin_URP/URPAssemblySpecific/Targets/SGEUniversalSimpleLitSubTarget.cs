...
{
   sealed class SGEUniversalSimpleLitSubTarget : SGEUniversalSubTarget, ILegacyTarget
    {
        static readonly GUID kSourceCodeGuid = new GUID("b2ef7193bf665d442a86af14307c3fbf"); // SGEUniversalSimpleLitSubTarget.cs
        ...
        public SGEUniversalSimpleLitSubTarget()
        {
            displayName = "SGE SimpleLit";
        }
        
        protected override SGEShaderID shaderID => SGEShaderID.SGE_SimpleLit;
        ...
        {
            context.AddProperty("Fragment Normal Space", new UnityEngine.UIElements.EnumField(NormalDropOffSpace.Tangent) { value = normalDropOffSpace }, (evt) =>
            {
        ...
        {
            blockMap = null;
            if(!(masterNode is SGESimpleLitMasterNode1 sgeSimpleLitMasterNode))
                return false;
            
            m_NormalDropOffSpace = sgeSimpleLitMasterNode.m_NormalDropOffSpace;
            ...
            blockMap = new Dictionary<BlockFieldDescriptor, int>()
            {
                ...
                { BlockFields.SurfaceDescription.Smoothness, 2 },
...
#region Passes
        static class LitPasses
        {
            ...
            {
                pass.defines.Add(SimpleLitDefines.SimpleLit);
            }
...
#region Includes
        static class LitIncludes
        {
            ...
            const string kForwardPass = "Assets/Plugins/ShaderGraphEssentials/Plugin/Editor/Plugin_URP/Shaders/SimpleLitForwardPass.hlsl";
            const string kGBuffer = "Packages/com.unity.render-pipelines.universal/ShaderLibrary/UnityGBuffer.hlsl";
            const string kPBRGBufferPass = "Assets/Plugins/ShaderGraphEssentials/Plugin/Editor/Plugin_URP/Shaders/SimpleLitGBufferPass.hlsl";
