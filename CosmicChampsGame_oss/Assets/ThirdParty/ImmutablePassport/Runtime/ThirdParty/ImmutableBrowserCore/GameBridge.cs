...
namespace Immutable.Browser.Core
{
    public static class GameBridge
    {
        ...
        private const string PASSPORT_PACKAGE_RESOURCES_DIRECTORY = "Assets/ThirdParty/ImmutablePassport/Runtime/Resources";
        ...
        private const string MAC_EDITOR_RESOURCES_DIRECTORY = "Assets/ThirdParty/ImmutablePassport/Runtime/Resources";
