...
mergeInto(LibraryManager.library,{
  ...
  InitializeInternal: function (callbackHandler, onAcquireReference, onReleaseReference, oldRuntime){
    var arrayBuilder = function(typeCode, pointer, length){
      switch (typeCode){
        case 5: return new Int8Array(wasmMemory.buffer, pointer, length);
        case 6: return new Uint8Array(wasmMemory.buffer, pointer, length);
        case 7: return new Int16Array(wasmMemory.buffer, pointer, length);
        case 8: return new Uint16Array(wasmMemory.buffer, pointer, length);
        case 9: return new Int32Array(wasmMemory.buffer, pointer, length);
        case 10: return new Uint32Array(wasmMemory.buffer, pointer, length);
        case 13: return new Float32Array(wasmMemory.buffer, pointer, length);
        case 14: return new Float64Array(wasmMemory.buffer, pointer, length);
        case 15: return new Uint8ClampedArray(wasmMemory.buffer, pointer, length);
      }
    }
